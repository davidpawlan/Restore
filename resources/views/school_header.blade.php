  ...
  <div class="profile_info">
    ...
    @endphp
          ...
          <ul>
            <Li>
            @if(empty($profilePic))
              <a href=""><p>@php echo substr(Auth::user()->name,0,1); @endphp</p></a>
               @else
              <a href=""><p><img style="width:30px;height:30px;border-radius:100%" class="img_header" src="{{URL::to('/')}}/public/uploads/profile_pic/{{$profilePic}}"></p></a>
                @endif

            </li>
            <li>
              <h5>
                @php echo substr(Auth::user()->name,0,10); @endphp
              </h5>
