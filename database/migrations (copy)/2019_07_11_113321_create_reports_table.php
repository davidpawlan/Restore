...
class CreateReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reports', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('student_id')->comment("Id of students table");
            $table->foreign('student_id')->references('id')->on('students');
            /*$table->integer("student_id")->comment("Id of students table");*/
            $table->enum("gender", ['M', 'F'])->comment("M=>Male, F=>Female");
            $table->unsignedBigInteger('behaviour_id')->comment("Id of behaviour table");
            ...
            $table->unsignedBigInteger('location_id')->comment("Id of locations table");
            $table->foreign('location_id')->references('id')->on('locations');

            /*$table->integer("intervention_id")->comment("Id of intervention table");*/
            $table->unsignedBigInteger('intervention_id')->comment("Id of interventions table");
            ...
            $table->longText("other_notes")->comment("0=>Poor, 1->Avg 2=>optimal");
