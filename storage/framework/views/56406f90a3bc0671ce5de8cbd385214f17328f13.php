...
<div class="pdfHeaderEport hide">
	...
	<div class="totalSchools">
		Total No. of Schools:
		<?php echo e($pdfArray['total_schools']); ?>
...
<section class="inner_home anylytc_home admin_analytcs">
	  <div class="col-md-12">
		<div class="top_filter">
				<h4>Filter By:</h4>
				<form class="filter_resilts" <?php if(isset($_GET['duration']) && $_GET['duration'] == "C"): ?> validate <?php else: ?> novalidate <?php endif; ?> >
...
<div class="col-md-12 text-center">
	<div class="btn_downld">
		<!-- <button class="btn btn-link download-pdf"><img src="<?php echo e(URL::to('/')); ?>/public/images/download.png">DOWNLOAD PDF REPORT</button> -->
		<button class="btn btn-link download-pdf"><img src="<?php echo e(URL::to('/')); ?>/public/images/download.png">DOWNLOAD PDF REPORT</button>
...
<?php /**PATH /var/www/html/restorewebsitephp/resources/views/Admin/analytics.blade.php ENDPATH**/ ?>